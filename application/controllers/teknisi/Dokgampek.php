...
class Dokgampek extends CI_Controller {
	...
	{
		parent::__construct();
        $this->load->model('teknisi/m_dokgampek');
	}
	...
	public function index()
	{
		...
		$isi = [
			'content'	=> 'teknisi/dokgampek/data_dokgampek',
			'data'		=> $this->db->query("SELECT * FROM dokgampek WHERE dokgampek_createby='$user_nama'")->result()
		];
    ...
    {
        $isi = [
            'content'   => 'teknisi/dokgampek/detail_dokgampek',
	...
	{
		$isi = [
			'content'   	=> 'teknisi/dokgampek/tambah_dokgampek',
	...
	public function simpan_dokgampek()
	{
		...
		redirect('teknisi/dokgampek');
	}

	public function edit_dokgampek($id)
    {
        $isi = [
            'content'   => 'teknisi/dokgampek/edit_dokgampek',
