...
class Jadser extends CI_Controller {
	...
	{
		parent::__construct();
        $this->load->model('admin/m_jadser');
	}
	...
	public function index()
	{
		...
		$isi = [
			'content'	=> 'admin/jadser/data_jadser',
    ...
    {
        $isi = [
            'content'   => 'admin/jadser/detail_jadser',
	...
	{
		$isi = [
			'content'   => 'admin/jadser/tambah_jadser',
    ...
    {
        $isi = [
            'content'   => 'admin/jadser/edit_jadser',
