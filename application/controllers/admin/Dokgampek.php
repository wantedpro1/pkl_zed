...
class Dokgampek extends CI_Controller {
	...
	{
		parent::__construct();
        $this->load->model('admin/m_dokgampek');
	...
	public function index()
	{
		...
		$isi = [
			'content'	=> 'admin/dokgampek/data_dokgampek',
    ...
    {
        $isi = [
            'content'   => 'admin/dokgampek/detail_dokgampek',
	...
	{
		$isi = [
			'content'   	=> 'admin/dokgampek/tambah_dokgampek',
    ...
    {
        $isi = [
            'content'   => 'admin/dokgampek/edit_dokgampek',
