<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= site_url('managerumum/profil/settings') ?>">Pengaturan Akun</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form method="POST" action="<?= base_url().'managerumum/profil/update_profil'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-action pull-right">
                        ...
                        <a href="<?= site_url('managerumum/Dashboard')?>" type="submit" class="btn btn-danger">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                ...
                <form method="POST" action="<?= base_url().'managerumum/profil/update_password'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
