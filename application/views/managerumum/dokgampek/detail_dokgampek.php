<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= site_url('managerumum/dokgampek/detail_dokgampek') ?>">Detail Dokumentasi Pekerjaan</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a class="btn btn-danger ml-auto pull-right" href="<?= site_url('managerumum/dokgampek')?>">
