<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= base_url('managerumum/jadser/tambah_jadser')?>">Tambah Jadwal</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" action="<?= base_url().'managerumum/jadser/simpan_jadser'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <input type="hidden" name="jadser_id" value="<?= $jadser_id;?>" class="form-control" readonly>
