            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-primary ml-auto" href="<?= base_url('managerumum/jadser/tambah_jadser')?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <button type="button" data-toggle="tooltip" title="" class="btn-link"><a href="<?= base_url()?>managerumum/jadser/detail_jadser/<?= $jadser_id;?>"><i class="fa fa-eye"></i></a>
                                            </button>
                                            <button type="button" data-toggle="tooltip" title="" class="btn-link"><a href="<?= base_url()?>managerumum/jadser/edit_jadser/<?= $jadser_id;?>"><i class="fa fa-edit"></i></a>                                             
                                            </button>
                                            <?php if($row->jadser_status == '0'):?>
