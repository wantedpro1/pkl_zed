<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= base_url('managerumum/teknisi/edit_teknisi')?>">Edit Data Teknisi</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" action="<?= base_url().'managerumum/teknisi/update_teknisi'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                ...
                                <div class="form-group mb-3 <?= form_error('user_email') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="user_email" value="<?= $data['user_email'];?>" class="form-control" id="email_teknisi" placeholder="Masukkan Email">
