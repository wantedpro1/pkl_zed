<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= base_url('superadmin/admin/tambah_admin')?>">Tambah Admin</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" action="<?= base_url().'superadmin/admin/simpan_admin'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?= site_url('superadmin/admin')?>" type="submit" class="btn btn-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
