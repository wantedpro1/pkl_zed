        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Edit Garansi</div>
                </div>
                <form method="POST" action="<?= base_url().'teknisi/garansi/update_garansi'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <!-- Bagian Tanggal -->
                        <div class="row">  
                            <input type="hidden" name="garansi_id" value="<?= $data['garansi_id'];?>" class="form-control" readonly>
                            <div class="col-md-6 col-lg-6">                                                              
                                <div class="form-group mb-3 <?= form_error('garansi_tgllaporan') ? 'has-error' : null?>">
                                    <label>Tanggal Laporan</label>
                                    <input type="datetime-local" name="garansi_tgllaporan" value="<?= $data['garansi_tgllaporan'];?>" class="form-control">
                                ...
                                <div class="form-group mb-3 <?= form_error('garansi_tglkunjungan') ? 'has-error' : null?>">
                                    ...
                                    <input type="datetime-local" name="garansi_tglkunjungan" value="<?= $data['garansi_tglkunjungan'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-6">                                                              
                                <div class="form-group mb-3 <?= form_error('garansi_tglperbaikan') ? 'has-error' : null?>">
                                    ...
                                    <input type="datetime-local" name="garansi_tglperbaikan" value="<?= $data['garansi_tglperbaikan'];?>" class="form-control">
                                ...
                                <div class="form-group mb-3 <?= form_error('garansi_tglselesai') ? 'has-error' : null?>">
                                    ...
                                    <input type="datetime-local" name="garansi_tglselesai" value="<?= $data['garansi_tglselesai'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">                                                              
                                <div class="form-group mb-3 <?= form_error('garansi_nowo') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_nowo" value="<?= $data['garansi_nowo'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_nofaktur') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_nofaktur" value="<?= $data['garansi_nofaktur'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">                                                              
                                <div class="form-group mb-3 <?= form_error('garansi_nama') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_nama" value="<?= $data['garansi_nama'];?>" class="form-control">
                                    <small style="color: red;"><?= form_error('garansi_nama')?></small>
                                </div>  
                                <div class="form-group mb-3 <?= form_error('garansi_alamat') ? 'has-error' : null?>">
                                    <label>Alamat</label>
                                    <input type="text" name="garansi_alamat" value="<?= $data['garansi_alamat'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-6">                                                                                             
                                <div class="form-group mb-3 <?= form_error('garansi_telepon') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_telepon" value="<?= $data['garansi_telepon'];?>" class="form-control">
                                    <small style="color: red;"><?= form_error('garansi_telepon')?></small>
                                </div>   
                                <div class="form-group mb-3 <?= form_error('garansi_kota') ? 'has-error' : null?>">
                                    <label>Kota</label>
                                    <input type="text" name="garansi_kota" value="<?= $data['garansi_kota'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_keluhan') ? 'has-error' : null?>">
                                    <label>Keluhan</label>
                                    <input type="text" name="garansi_keluhan" value="<?= $data['garansi_keluhan'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_produk') ? 'has-error' : null?>">
                                    <label>Produk</label>
                                    <input type="text" name="garansi_produk" value="<?= $data['garansi_produk'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_tglbeli') ? 'has-error' : null?>">
                                    ...
                                    <input type="date" name="garansi_tglbeli" value="<?= $data['garansi_tglbeli'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="form-group mb-3 <?= form_error('garansi_nobukkun') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_nobukkun" value="<?= $data['garansi_nobukkun'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_noseri') ? 'has-error' : null?>">
                                    <label>No. Seri</label>
                                    <input type="text" name="garansi_noseri" value="<?= $data['garansi_noseri'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_partno') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_partno" value="<?= $data['garansi_partno'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <div class="form-group mb-3 <?= form_error('garansi_aktivser') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_aktivser" value="<?= $data['garansi_aktivser'];?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_ongkostransport') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_ongkostransport" value="<?= $data['garansi_ongkostransport'];?>" class="form-control">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group mb-3 <?= form_error('garansi_ongkoskerja') ? 'has-error' : null?>">
                                    ...
                                    <input type="text" name="garansi_ongkoskerja" value="<?= $data['garansi_ongkoskerja'];?>" class="form-control">
