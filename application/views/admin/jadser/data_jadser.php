                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <?php if($row->jadser_status == '0'):?>
                                                ...
                                                <button type="button" data-toggle="tooltip" title="" class="btn-link"><a id="jadser-batal" href="<?= base_url()?>admin/jadser/batal_jadser/<?= $jadser_id;?>"><i class="fa fa-times"></i></a>                   
                                                </button>
                                            <?php endif;?>
