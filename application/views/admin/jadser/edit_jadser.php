<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= base_url('admin/jadser/edit_jadser')?>">Edit Jadwal</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" action="<?= base_url().'admin/jadser/update_jadser'?>" class="form-sample" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
