<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= site_url('admin/dokgampek') ?>">Dokumentasi Pekerjaan</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-primary ml-auto" href="<?= base_url('admin/dokgampek/tambah_dokgampek')?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <?php if($row->dokgampek_status == '0'):?>
                                                <button type="button" data-toggle="tooltip" title="" class="btn-link"><a id="dokgampek-setuju" href="<?= base_url()?>admin/dokgampek/setuju_dokgampek/<?= $dokgampek_id;?>"><i class="fa fa-check"></i></a>                   
                                                </button>
                                                <button type="button" data-toggle="tooltip" title="" class="btn-link"><a id="dokgampek-tolak" href="<?= base_url()?>admin/dokgampek/tolak_dokgampek/<?= $dokgampek_id;?>"><i class="fa fa-times"></i></a>                   
                                                </button>
                                            <?php endif;?>
                                            <button type="button" data-toggle="tooltip" title="" class="btn-link"><a id="tombol-hapus" href="<?= base_url()?>admin/dokgampek/hapus_dokgampek/<?= $dokgampek_id;?>"><i class="fa fa-trash"></i></a>                   
                                            </button>                                           
                                        </div>
                                    </td>
                                </tr>
